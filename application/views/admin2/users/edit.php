...
<div class="box box-default">
    ...
    <!-- form start -->
    <?=form_open_multipart('admin/edit/'.$user->id);?>
      <div class="row">
        <div class="col-sm-4 col-sm-offset-1">
          <div class="box-body">
            ...
            <div class="form-group <?php echo (form_error('username')!=null) ? 'has-error' : ''; ?>">
              ...
              <input type="text" class="form-control" id="username" name="username" placeholder="Digunakan untuk login" value="<?=set_value('username', $user->username); ?>" disabled>
